...
-- Display the ProductName and CategoryName for all products in the database. Shows 77 records.
    SELECT p.ProductName, c.CategoryName FROM Product p INNER JOIN Category c on p.Productid = c.Categoryid 
...
-- Display the name and quantity of the products ordered in order with Id 10251. Sort by ProductName. Shows 3 records.
    SELECT o.quantity, p.productName FROM orderdetail AS o JOIN product AS p ON o.ProductId = p.id WHERE o.OrderId = 10251;
